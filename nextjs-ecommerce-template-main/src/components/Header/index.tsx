...
const Header = () => {
  ...
  return (
    <header
      className={`fixed left-0 top-0 w-full z-9999 bg-[#fab637]  ${
        stickyMenu && "shadow"
      }`}
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
          className={`flex flex-col lg:flex-row gap-2 items-end lg:items-center xl:justify-between ease-out duration-200  ${
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            ...
            <Image
                 src="/images/logo/logo.svg"
                  alt="not"
              width={80} // Adjusted width for square shape
              height={100} // Adjusted height for square shape
              style={{
        ...
        />
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            <div className="hidden xl:flex items-center gap-3.5">
              ...
              <div>
                <span className="block text-2xs text-[#db042f] uppercase">
                  24/7 SUPPORT
                </span>
                <p className="font-medium text-custom-sm text-[#db042f]">
                  (+92)318-1223474 
                </p>
              </div>
            </div>
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                <Link href="/signin" className="flex items-center gap-2.5">
                  ...
                  <div>
                    <span className="block text-2xs text-[#6484f5] uppercase">
                      account
                    </span>
